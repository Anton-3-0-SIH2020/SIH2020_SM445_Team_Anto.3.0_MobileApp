class Endpoints {
  static final String baseUrl =
      'https://corporate-action-rest-api.herokuapp.com';
  ...
  static final String predictedCa = '/api/predicted_ca';
  ...
  static final String downloadNseCsv = '/download/nse_csv';
  static final String downloadMcPdf = '/download/mc_pdf';
  static final String downloadMcCsv = '/download/mc_csv';
}
