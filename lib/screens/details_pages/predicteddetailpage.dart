...
class PredictedDetailsPage extends StatefulWidget {
  final PredictedCaModel data;

  PredictedDetailsPage({
    Key key,
    @required this.data,
  }) : super(key: key);

  @override
  _PredictedDetailsPageState createState() => _PredictedDetailsPageState();
}

class _PredictedDetailsPageState extends State<PredictedDetailsPage> {
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  DetailsBox("Company Name", widget.data.securityName),
                  SizedBox(
